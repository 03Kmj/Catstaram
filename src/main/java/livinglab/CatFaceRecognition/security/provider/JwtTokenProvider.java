package livinglab.CatFaceRecognition.security.provider;

import io.jsonwebtoken.*;
import io.jsonwebtoken.io.Decoders;
import io.jsonwebtoken.security.Keys;
import jakarta.servlet.http.HttpServletRequest;
import livinglab.CatFaceRecognition.auth.dto.TokenDto;
...
import livinglab.CatFaceRecognition.security.details.PrincipalDetails;
...
public class JwtTokenProvider {
    ...
    public Authentication getAuthentication(String accessToken, AccountRepository accountRepository){
